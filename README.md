...
\[amd64\]](https://github.com/ijapesigan/docker-torch/actions/workflows/docker-apptainer-build-push-amd64.yml/badge.svg)](https://github.com/ijapesigan/docker-torch/actions/workflows/docker-apptainer-build-push-amd64.yml)
[![Docker and Apptainer Build and Push \[amd64\]
(Daily)](https://github.com/ijapesigan/docker-torch/actions/workflows/docker-apptainer-build-push-daily-amd64.yml/badge.svg)](https://github.com/ijapesigan/docker-torch/actions/workflows/docker-apptainer-build-push-daily-amd64.yml)
[![Make
...
``` bash
docker run --rm -ti -e PASSWORD=yourpassword -p 127.0.0.1:8787:8787 ijapesigan/torch
```
...
``` bash
apptainer pull docs.sif docker://ijapesigan/torch:latest
```
